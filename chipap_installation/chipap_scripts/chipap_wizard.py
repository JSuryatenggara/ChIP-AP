...
read_mode_string_var.trace_add('write', check_traced_input_function)
peak_type_string_var.trace_add('write', check_traced_input_function)
chip_rep1_r1_string_var.trace_add('write', register_sample_function)
chip_rep1_r2_string_var.trace_add('write', register_sample_function)
chip_rep2_r1_string_var.trace_add('write', register_sample_function)
chip_rep2_r2_string_var.trace_add('write', register_sample_function)
chip_rep3_r1_string_var.trace_add('write', register_sample_function)
chip_rep3_r2_string_var.trace_add('write', register_sample_function)
chip_rep4_r1_string_var.trace_add('write', register_sample_function)
chip_rep4_r2_string_var.trace_add('write', register_sample_function)
chip_rep5_r1_string_var.trace_add('write', register_sample_function)
chip_rep5_r2_string_var.trace_add('write', register_sample_function)
ctrl_rep1_r1_string_var.trace_add('write', register_sample_function)
ctrl_rep1_r2_string_var.trace_add('write', register_sample_function)
ctrl_rep2_r1_string_var.trace_add('write', register_sample_function)
ctrl_rep2_r2_string_var.trace_add('write', register_sample_function)
ctrl_rep3_r1_string_var.trace_add('write', register_sample_function)
ctrl_rep3_r2_string_var.trace_add('write', register_sample_function)
ctrl_rep4_r1_string_var.trace_add('write', register_sample_function)
ctrl_rep4_r2_string_var.trace_add('write', register_sample_function)
ctrl_rep5_r1_string_var.trace_add('write', register_sample_function)
ctrl_rep5_r2_string_var.trace_add('write', register_sample_function)
sample_table_question_string_var.trace_add('write', register_sample_function)
sample_table_string_var.trace_add('write', check_traced_input_function)
sample_table_string_var.trace_add('write', sample_table_entry_trace_load_function)
setting_table_question_string_var.trace_add('write', check_required_input_function)
setting_table_string_var.trace_add('write', check_traced_input_function)
setting_table_string_var.trace_add('write', setting_table_entry_trace_load_function)
genome_ref_string_var.trace_add('write', check_traced_input_function)
genome_folder_string_var.trace_add('write', check_traced_input_function)
known_motif_question_string_var.trace_add('write', check_required_input_function)
known_motif_string_var.trace_add('write', check_traced_input_function)
setname_string_var.trace_add('write', check_traced_input_function)
output_folder_string_var.trace_add('write', check_traced_input_function)
fcmerge_var.trace_add('write', update_command_line_function)
goann_var.trace_add('write', update_command_line_function)
pathann_var.trace_add('write', update_command_line_function)
deltemp_var.trace_add('write', update_command_line_function)
stdout_var.trace_add('write', update_command_line_function)
homer_motif_question_string_var.trace_add('write', check_traced_input_function)
homer_motif_string_var.trace_add('write', check_traced_input_function)
meme_motif_question_string_var.trace_add('write', check_traced_input_function)
meme_motif_string_var.trace_add('write', check_traced_input_function)
cpu_count_string_var.trace_add('write', check_traced_input_function)
...
image = image.resize((800, 295), Image.LANCZOS)
