...
read_mode_string_var.trace_add('write', register_sample_function)
...
homer_motif_string_var.trace_add('write', update_command_line_function)
meme_motif_string_var.trace_add('write', update_command_line_function)
